                          ...
                          >
                            ...
                            >
                              <ul
                                ...
                                v-if="
                                  vacancyList.some(
                                    (data) => data.date === formattedDate(day)
                                  )
                                "
                              >
                                <li
                                      ...
                                      <span>
                                        <span>
                                          ...
                                          >
                                            <span
                                              :draggable="
                                                getBookingStatus(assign) !== 'Booked'
                                              "
                                              @dragstart="
                                                getBookingStatus(assign) !== 'Booked' &&
                                                  handleDragRevert(
  ...
  methods: {
    ...
    async fetchCandidateList() {
      ...
      try {
        ...
        // this.assignStaffDisplay = availabilityArray.flatMap(
        //   (avail) => avail.assign_vacancies || []
        // );
